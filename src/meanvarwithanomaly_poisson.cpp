...
std::vector<int> PoissonAnomaly(SEXP Rx, SEXP Rn, SEXP Rminlength, SEXP Rmaxlength, SEXP Rbetachange, SEXP Rbetaanomaly, SEXP Ronline)
// SEXP PoissonAnomaly(SEXP Rx, SEXP Rn, SEXP Rminlength, SEXP Rmaxlength, SEXP Rbetachange, SEXP Rbetaanomaly, SEXP Ronline)
{
  ...
  */
	...
	error = solveorderedobservationlist_poisson(mylist, n, betavector, betaanomaly, minlength, maxlength);
